package ent.sahoo.shoppingbackend.config;
...
@Configuration
@ComponentScan(basePackages= {"ent.sahoo.shoppingbackend.dto"})
@EnableTransactionManagement
public class HibernateConfig {
	
	// Change the below parameters if you are changing to any new Databases
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("ent.sahoo.shoppingbackend.dto");
